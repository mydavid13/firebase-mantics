package seyitini.david.travellingmantics;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                chooseImageIntent.setType("image/jpeg");
                chooseImageIntent.putExtra(Intent.EXTRA_LOCAL_ONLY, true);
                startActivityForResult(chooseImageIntent.createChooser(chooseImageIntent,
        ...
        if (requestCode == PICTURE_RESULT && resultCode == RESULT_OK) {
            ...
            ref.putFile(imageUri).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    String urle = download.toString();
                    String pictureUrl = taskSnapshot.getUploadSessionUri().toString();
                    //ref.getDownloadUrl().toString();
                    //String url = taskSnapshot.getDownloadUrl().toString();
                    //String pictureName = taskSnapshot.getStorage().getPath();
                    //deal.setImageUrl(url);
                    deal.setImageName(pictureUrl);
